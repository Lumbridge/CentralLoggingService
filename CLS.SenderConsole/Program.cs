                ...
                if (randomNumber <= 29) // 30% chance
                {
                    ...
                    if (r.Next(0, 2) == 1)
                    {
                        ls.Log(StaticData.SeverityType.Debug,
                              new Exception($"This {messageType} message was randomly generated by the CLS Sender Console."),
                              $"This {messageType} message was randomly generated by the CLS Sender Console.");
                    }
                    else
                    {
                        ls.Log(StaticData.SeverityType.Debug,
